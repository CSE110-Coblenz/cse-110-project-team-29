...
export class Act1View implements View {
    ...
    constructor() {
        ...
        const cardX = (STAGE_WIDTH - cardWidth) / 2;
        const cardY = (STAGE_HEIGHT - cardHeight) / 2 - 30;
    ...
    private positionInput() {
        ...
        const inputY = cardY + cardHeight + 40; // below the card
